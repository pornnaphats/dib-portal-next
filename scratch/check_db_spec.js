...
async function checkSpec() {
  ...
  if (res.ok) {
    ...
    console.log("Paths available:", Object.keys(spec.paths));
    const empPath = spec.paths['/employees'];
    console.log("Employees path info:", JSON.stringify(empPath, null, 2));
  } else {
    console.log("Failed to fetch spec:", await res.text());
  }
}
checkSpec();
